...
async function visualizaDadosGlobais(){
    ...
    paragrafo.innerHTML = `O mundo tem <span> ${totalPessoasMundo} bilhões  </span> de habitantes , dos quais <span> ${totalPessoasConectadas}  </span>
    bilhões estão conectados em alguma rede social por um tempo médio de  <span> ${tempoMedio} horas </span>.`
